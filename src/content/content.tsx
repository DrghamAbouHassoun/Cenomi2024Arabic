const content = {
  ...
  pages: {
    ...
    Leadership: {
      tabLabels: [["Chairman’s Statement", "CEO’s Message"], ["كلمة رئيس مجلس الإدارة", "كلمة الرئيس التنفيذي"]],
      title: ["Leadership", "كلمة الإدارة"],
      subtitle: ["Cenomi Retail is entering a new era of focus and ambition", "تستعد سينومي ريتيل اليوم لمرحلة جديدة من النمو تتميز بأعلى درجات التركيز والطموح."]
    },
    Chairman: {
      quote: [
        "We remain focused on further refining our brand portfolio and strengthening our financial position",
        "سنواصل جهودنا خلال عام 2025م نحو الارتقاء بمحفظة علاماتنا التجارية وترسيخ مركزنا المالي",
      ],
      name: ["Fawaz Bin Abdulaziz Alhokair", "فواز بن عبدالعزيز الحكير"],
      position: ["Chairman ", "رئيس مجلس الإدارة "],
      counter: {
        countValue: 4.8,
        underText: ["Revenue", "الإيرادات"],
        suffix: [" bn", <span><span className="riyalBigText"> & </span> مليار </span>],
        prefix: [<span className="riyalBigText">& </span>, ""],
      },
      building: ["Building a Stronger Foundation for Sustainable Growth", "إرساء دعائم قوية للنمو المستدام"],
      buildingText: [
        [
          <span>
          ...
          <span>
            تستعد سينومي ريتيل اليوم لمرحلة جديدة من النمو تتميز بأعلى درجات التركيز والانضباط الاستراتيجي، مرتكزةً على إنجازات العام المنصرم الذي قطعت فيه أشواطاً كبيرةً للارتقاء بأداء محفظتها وتحسين كفاءتها التشغيلية وتعزيز مركزها المالي. وقد أسهمت الخطوات الاستراتيجية التي اتخذناها في وضع الشركة بثقة على مسار النمو طويل الأجل، بما يضمن تحقيق أفضل قيمة ممكنة لمساهمينا في المستقبل. وفيما يواصل قطاع التجزئة مسيرة تطوره الواعدة في ظل مؤشراته الإيجابية، فإننا نجدد تأكيدنا على مواصلة العمل لتحقيق الربحية المستدامة وترسيخ مكانتنا باعتبارنا شركة رائدة في تجارة التجزئة بالمملكة.
          </span>
        ],
        [],
      ],
      strategic: ["Strategic Transformation and  Performance", "التحول الاستراتيجي وتعزيز الأداء"],
      strategicText: [
        [
        ...
        [
          <span>شهد العام المنصرم تنفيذاً دقيقاً وحازماً لاستراتيجيتنا ذات المراحل المتعددة، والتي بدأت بمرحلة إعادة تنظيم للعمليات وصولاً إلى بناء نموذج للنمو المستدام. وبالاستناد إلى منهجية مدروسة بعناية، قمنا بإعادة ضبط وهيكلة محفظتنا من خلال تحسين العلامات التجارية مع التركيز على العلامات التجارية الرائدة، وتعزيز الكفاءة التشغيلية. ولم يقتصر أثر هذا التحول المنهجي على الارتقاء بمركزنا المالي فحسب، بل أسهم في تعزيز مرونة سينومي ريتيل وانسيابية أعمالها وقدرتها على تحقيق النمو والتوسع وزيادة أرباحها. </span>,
          <span>وعلى مدار العام، عملنا على تحسين كفاءة وانسيابية عملياتنا من خلال تصفية العلامات التجارية غير المحورية، وتحقيق أرباح رأسمالية، وإغلاق المتاجر ذات الأداء المتدني. وقد مكنتنا هذه الخطوة من توجيه مواردنا نحو العلامات التجارية ذات الأداء المتميز، مما يضمن تحقيق نمو مستدام في الإيرادات.</span>,
          <span>سجلت الأسواق الرئيسية في نطاق محفظتنا الدولية أداءً قوياً خلال عام 2024م، بصدارة كل من أذربيجان وجورجيا. وجاء دخولنا الناجح إلى السوق الأوزبكي، والذي شهد تسجيل إيرادات جيدة في العام الأول، ليؤكد على توجهنا نحو أسواق تجزئة قابلة للتوسع وتتمتع بآفاق نمو واعدة.</span>
        ],
      ],
      saudi: ["Saudi Arabia’s Evolving Retail Landscape", "قطاع التجزئة السعودي: تحولات وفرص"],
      saudiText: [
        [
          <span>
        ...
        [
          <span>يشهد قطاع التجزئة في المملكة العربية السعودية تحولاً متسارعاً ومدفوعاً، بمبادرات رؤية المملكة 2030، والتطور العمراني، وتغير أذواق المستهلكين. ففي نهاية عام 2024م، بلغ إجمالي القيمة السوقية للقطاع 670 <span className="riyal-small">&</span> مليار، مع توقعات بنمو سنوي قدره 7.1% على مدى الأعوام الخمسة المقبلة. وما يزال المستهلك السعودي يتمتع بإقبال قوي على الشراء، وسط تنامي الطلب على العلامات التجارية العالمية الراقية، والتوجه نحو تجارب تسوق ذات قيمة متميزة، إلى جانب حلول التجزئة متعددة القنوات. وتتبوأ سينومي ريتيل موقعاً استراتيجياً يمكنها من الاستفادة من هذه التحولات في تنفيذ خطط توسع مدروسة لفروعها ومتاجرها وإبرام شراكات استراتيجية مع العلامات التجارية الفاخرة، بالإضافة إلى تقديم حلول مبتكرة في مجال التجزئة متعددة القنوات.</span>,
          <span>وعلى نحو مماثل، يشهد القطاع العقاري تحولات جذرية، تزامناً مع اقتراب إطلاق عدد من مشاريع التطوير العملاقة، أبرزها جوهرة جدة، وجوهرة الرياض، والدرعية، والتي سيكون لها دور محوري في رسم ملامح جديدة لمستقبل قطاع التجزئة بالمملكة. وتتمتع سينومي ريتيل بمكانة استراتيجية مهمة في السوق تخّولها الاستفادة من الفرص الواعدة التي تحملها هذه التطورات، وتمكنها من الحصول على مواقع حيوية تستقطب أعداداً كبيرةً من الزوار، إلى جانب تقديم مفهوم مبتكر في متاجر التجزئة يُثري تجربة المتسوقين.</span>,
          <span>في الوقت الذي ما تزال فيه التجارة الرقمية تشكل ركيزةً أساسية في منظومة قطاع التجزئة، تشير التوقعات إلى بلوغ المبيعات عبر الإنترنت 90 <span className="riyal-small">&</span> مليار بحلول عام 2026م. وفيما شهدت مبيعاتنا عبر المنصات الإلكترونية تراجعاً مؤقتاً نتيجة لبرنامج بيع العلامات التجارية، فإننا نسعى جاهدين لتطوير إمكاناتنا الرقمية لمواكبة التحول في سلوك المستهلك.</span>
        ],
      ],
      driving: ["Driving Growth of Tier 1 Champion Brands", "تعزيز نمو العلامات التجارية الرائدة"],
      drivingText: [
        [
          <span>
        ...
        [
          <span>لقد أثمر اهتمامنا المتواصل بالعلامات التجارية الرائدة على مدار العام عن توطيد علاقاتنا مع شركائنا من العلامات التجارية العالمية، وتنمية آفاق النمو المستقبلية. ويعّد تجديد وتوسيع متجر زارا في النخيل مول الرياض – المتجر الأفضل أداءً لزارا في المملكة – دليلاً واضحاً على جدوى الاستثمار في المواقع الحيوية، حيث من المتوقع أن يحقق هذا المتجر، بعد زيادة مساحته، نمواً ملحوظاً في الإيرادات خلال العام المقبل.</span>,
          <span>وفي قطاع الأغذية والمشروبات، افتتحت الشركة 12 فرعاً جديداً لـمطاعم صب واي في يوم واحد في شهر أكتوبر، إلى جانب 14 فرعاً في يوم واحد في شهر ديسمبر، محققة بذلك رقماً قياسياً عالمياً جديداً. وتتضمن المنافذ مزيجاً من المطاعم التقليدية والمطاعم ضمن مكاتب الشركات إلى جانب المطابخ السحابية. وتمثل هذه التوسعة خطوة استراتيجية لترشيد التكاليف وفتح آفاق واعدة أمام علامة صب واي لتحقيق نمو طويل الأجل ضمن قطاع المطاعم السعودية المتنامية والقائمة على الخدمة السريعة.</span>,
        ],
      ],
      looking: ["Looking Ahead to 2025", "تطلعاتنا للعام 2025م"],
      lookingText: [
        [
          <span>
        ...
        [
          <span>تستعد سينومي ريتيل لدخول مرحلة مفصلية في رحلتها الاستراتيجية، فبعد تحقيق تقدم ملحوظ في تحسين محفظتنا وتعزيز الانضباط المالي خلال العام الماضي، سنواصل جهودنا خلال عام 2025م نحو الارتقاء بمحفظة علاماتنا التجارية وترسيخ مركزنا المالي، بالإضافة إلى تكثيف العمل لتنفيذ خطتنا الاستراتيجية للنمو المستدام.</span>,
          <span>وسينصب تركيزنا على توسيع محفظتنا من العلامات التجارية الرائدة من الدرجة الأولى، بما يعزز ريادتنا في السوق ويدعم النمو المستدام لأعمالنا على المدى الطويل. كما ستشهد الشركة تسارعاً في وتيرة التحول الرقمي، مدعوماً بالابتكارات القائمة على الذكاء الاصطناعي في قطاع التجزئة، مما يسهم في تعزيز مشاركة العملاء وزيادة المرونة التشغيلية للشركة. وباعتبار الكفاءة في صدارة أولوياتنا، فإننا سنواصل العمل على تحسين النفقات التشغيلية وضبط التكاليف، إلى جانب دعم جهود التوسع الدولي من خلال التركيز على الأسواق القابلة للتوسع ذات الهوامش الربحية العالية وإمكانات النمو الواعدة. وفي الوقت ذاته، سنستمر في ترشيد التكاليف وتخفيض المديونية بما يعزز مرونتنا المالية ويمكّن سينومي ريتيل من تحقيق ربحية مستدامة.</span>,
        ],
      ],
      acknowledgments: ["Acknowledgments", "شكر وتقدير "],
      acknowledgmentsText: [
        [
        ...
        [
          <span>بالنيابة عن مجلس الإدارة، أتوجه بخالص الشكر والامتنان إلى مساهمينا الكرام على ثقتهم الغالية ودعمهم المتواصل. كما أتقدم بجزيل الشكر والعرفان إلى شركائنا من العلامات التجارية، والممولين، والموردين على تعاونهم المثمر والتزامهم الراسخ. وأخيراً، أود أن أشيد بموظفينا على إخلاصهم وتفانيهم، حيث كانت مساهماتهم داعماً رئيسياً لمسيرة سينومي ريتيل الحافلة بالإنجازات.</span>,
          <span>لقد كان العام المنصرم بمثابة مرحلة تأسيسية عملنا خلالها على تعزيز أسس الشركة وتمكينها بالأدوات اللازمة لتحقيق النمو في المستقبل. وفيما نمضي قدماً، نؤكد عزمنا على تحقيق القيمة المضافة، واستثمار الفرص المتاحة، وضمان النجاح والازدهار المستدام لجميع أصحاب المصلحة.</span>
        ],
      ],
    },
    CEO: {
      quote: ["Sharper. Leaner. Ready for growth.", "كفاءة أعلى، أداء أكثر سلاسة، نمو بلا حدود."],
      name: ["Salim Fakhouri", "سليم فاخوري"],
      position: ["Chief Executive Officer  ", "الرئيس التنفيذي"],
      counter: {
        countValue: 631.5,
        underText: ["Gross Profit", "نمو إجمالي الربح"],
      ...
      intro: [
        ...
        "استهلّت سينومي ريتيل عام 2024م بأولوية استراتيجية واضحة المعالم تمثلت في إعادة صياغة نموذج أعمالها لتصبح منصة نمو ديناميكية أكثر تركيزاً واستجابة للتغيرات وقابلية للتوسع المدروس. وقد استلزم تحقيق هذا التحوّل الاستراتيجي تعزيز دقة التنفيذ وتطوير كفاءة الهيكل التنظيمي، فضلاً عن مواءمة الأولويات مع المجالات التي تحقق أعلى قيمة وأفضل معدلات الربحية سواء في الوقت الراهن أو على امتداد السنوات المقبلة. لم يكن التحول الذي شرعنا فيه مجرد سعي لتحقيق الكفاءة التشغيلية فحسب، بل كان بناءً متكاملاً للقدرات المؤسسية والرؤية الاستراتيجية الواضحة التي تمكّننا من النمو بشكل مدروس ومستدام. ونستعرض فيما يلي موجزًا لكيفية إرسائنا لتلك الأسس، وكيف أصبحت سينومي ريتيل الآن مهيأة للمضي قدمًا بقوة وثبات على المسار الصحيح، وبتوجه استراتيجي واضح نحو فصل جديد في مسيرتها.",
      ],
      resetting: [
        "Resetting with Resilience. Transforming for the Future.",
        "إعادة ضبط بوصلة الأعمال لتحقيق المرونة والتحول المنشود",
      ],
      resettingText: [
        [
          <span>
        ...
        [
          <span>نفّذت سينومي ريتيل في عام 2024م أشمل عملية تحول استراتيجي في تاريخها المؤسسي. انطلقنا في رحلة تحول جذري شملت جميع أبعاد أعمالنا - من المحفظة الاستثمارية إلى العمليات التشغيلية والهيكل التنظيمي – بهدف واضح: التأهب لنمو منضبط وقابل للتوسع المستدام. استلزم ذلك منّا اتخاذ قرارات جريئة وحاسمة، بدءاً من ترشيد محفظة العلامات التجارية وصولاً إلى تحسين تصاميم المتاجر وتطوير نماذجها التشغيلية، وذلك لتركيز جهودنا على الأصول عالية الأداء وذات الإمكانات الواعدة للنمو المستقبلي. وتمحورت استراتيجيتنا حول تعزيز النواة الأساسية للأعمال ألا وهي إعطاء الأولوية للعلامات التجارية الرائدة، وترشيد حجم انتشارنا الجغرافي بما يتناسب مع الأداء الفعلي، وتهيئة الظروف المثلى لخلق قيمة مستدامة على المدى الطويل.</span>,
          <span>شكّل تحويل محفظة متاجرنا ركيزة مهمة في عملية إعادة ضبط بوصلة أعمالنا. فبدلاً من التركيز على الحجم المطلق أو العدد الإجمالي للمتاجر، سعينا لتحقيق الجودة والكفاءة التشغيلية. جاءت عمليات الإغلاق مدروسة ومتوافقة مع رؤيتنا بأن التوسع الحقيقي يجب أن يكون مدفوعاً بالإنتاجية والأداء، وليس مجرد الحضور الجغرافي. ويُجسّد متجر زارا الرئيسي في النخيل مول هذا التحول النوعي: فهو أكبر حجماً، ومُجدّد بالكامل، ومُجهز رقمياً بأحدث التقنيات للارتقاء بتجربة العملاء ودعم النمو المستقبلي. وعبر محفظتنا الاستثمارية، واصلنا الاستثمار في مساحات تجزئة أعلى جودة للعلامات التجارية الرئيسية في المواقع المعروفة وكثيفة الحركة، مما يعزز استراتيجيتنا في التوسع حيث تكمُن القيمة الحقيقية.</span>,
          <span>امتد التحول ليشمل أعماق النموذج التشغيلي. فقد رسّخنا انضباطاً أكبر في عمليات الشراء والتوريد، وحسّنا الهياكل الوظيفية، وأعدنا هيكلة العمليات الأساسية لزيادة الاستجابة والتحكم الإداري. ونجحنا في ضبط حركة المخزون بدقة أكبر، مما قلّل من أوجه عدم الكفاءة ووائم مستويات المخزون مع طلب العملاء الفعلي. لم تكن هذه التغييرات سطحية أو شكلية – بل كانت هيكلية وجوهرية، مُصممة لتجعل من سينومي ريتيل شركة أكثر تركيزاً في الأولويات ومرونة في الأداء. ومع دخولنا المرحلة التالية من مسيرة نمونا، فإننا نتمتع اليوم بنموذج أعمال أكثر بساطة وتركيزاً، ومُجهّز بشكل أفضل لاقتناص الفرص المستقبلية الواعدة.</span>
        ],
      ],
      stronger: ["Stronger Results. Strengthening the Core.", "تحسن ملموس في النتائج المالية ودعم الأسس لانطلاقة قوية"],
      strongerText: [
        [
          <span>
        ...
        [
          <span>حققت سينومي ريتيل أداءً مالياً محسّناً بشكل ملحوظ في عام 2024م، حيث ارتفعت الإيرادات بنسبة 3,7% على أساس سنوي لتصل إلى 4,8 <span className="riyal-small">&</span> مليار. ونما إجمالي الربح بنسبة 5,8% ليصل إلى 631,5 <span className="riyal-small">&</span> مليون، مدعوماً بتحسّن المبيعات، وانخفاض مخصصات المخزون، والتنفيذ المستمر لمبادرات تحسين التكاليف وترشيد العلامات التجارية. وتحسّنت الأرباح قبل الفوائد والضرائب والإهلاك والاستهلاك من سالب 115 % مليون في عام 2023م إلى موجب 469 <span className="riyal-small">&</span> مليون في عام 2024م، مما يمثل نقطة تحول واضحة في مسار ربحية الشركة. ووصل هامش الأرباح قبل الفوائد والضرائب والإهلاك والاستهلاك إلى 9,7%، مدعوماً بتحسين كفاءة التكاليف والعمليات التشغيلية عبر الأسواق الأساسية.</span>,
          <span>انخفض صافي الخسارة بشكل حاد من 1,1 <span className="riyal-small">&</span> مليار في عام 2023م إلى 197 <span className="riyal-small">&</span> مليون في عام 2024م، بفضل الإدارة المنضبطة للمصاريف العمومية والإدارية وتحسين كفاءة المبيعات، حيث انخفض إجمالي المصاريف العمومية والإدارية وتكلفة المبيعات بنسبة 23% على أساس سنوي. وبلغ متوسط انكماش المخزون 0,75% من الإيرادات – وهو أقل بكثير من المعايير العالمية التي تتراوح بين 1,38% إلى 1,62% – مما يعكس إدارةً أفضل ووضوحاً أعلى في مستويات المخزون، ويؤكد التأثير الإيجابي لمبادرات الترشيد التشغيلي.</span>,
          <span>حققت سينومي ريتيل أيضاً تقدماً كبيراً في تخفيض مستوى المديونية في ميزانيتها العمومية، حيث بلغت مدفوعات الديون الإجمالية 664 <span className="riyal-small">&</span> مليون ما أدى إلى انخفاض بنسبة 31,6% في صافي الدين على أساس سنوي.</span>,
        ],
      ],
      accelerating: ["Accelerating Divisional Progress and Performance", "تسريع وتيرة التقدم والأداء على مستوى وحدات الأعمال"],
      acceleratingText: [
        [
          <span>
        ...
        [
          <span>يعكس أداء سينومي ريتيل لعام 2024م التقدم المحرز في تنفيذ استراتيجيتها المدروسة عبر جميع وحدات الأعمال. وتواصل الشركة التركيز على تحسين تجربة التسوق لعملائها، والارتقاء بكفاءة العمليات التشغيلية، وتعميق مشاركة العملاء عبر القنوات المادية والرقمية. ومن بين العوامل التي دعمت ارتفاع إجمالي الإيرادات السنوية إلى ما يقارب 5 <span className="riyal-small">&</span> مليارات، النمو الدولي القوي ومساهمة عمليات افتتاح المتاجر الجديدة للعلامات التجارية الرائدة.</span>,
          <span>وتظل عمليات التجزئة في المملكة العربية السعودية السوق الأساسي لسينومي ريتيل، فقد بلغت إيراداتها السنوية للعام 3,2 <span className="riyal-small">&</span> مليار، مما يمثل 66% من إجمالي الإيرادات الموحدة. وبينما يعكس هذا انخفاضاً بنسبة 1,7% على أساس سنوي بسبب تأثير برنامج ترشيد العلامات التجارية، تشير نتائج الربع الرابع إلى اتجاه تعافٍ مدعوم بالحملات التسويقية الموجهة والاستثمارات المركزة في المتاجر. وتجسّد إعادة افتتاح أكبر متاجر زارا في المملكة في النخيل مول بالرياض الاستراتيجية الرامية لدفع النمو من خلال المواقع الرائدة الرئيسية. فقد حقق هذا الموقع وحده زيادة في الإيرادات بنسبة 40% على أساس سنوي في ديسمبر 2024م.</span>,
          <span>وقدّمت عمليات التجزئة الدولية أداءً متميزاً في عام 2024م، حيث وصلت الإيرادات إلى 1,3 <span className="riyal-small">&</span> مليار، بزيادة قدرها 26,5% على أساس سنوي. وتواصل الشركة توسيع بصمتها في أسواق النمو عالية الإمكانات، مع مساهمات متميزة من أذربيجان وجورجيا ودخول ناجح لسوق أوزبكستان، والتي حققت 132 % مليون في عامها الأول. ويعكس ذلك استراتيجية المجموعة للتوسع الدولي المنضبط من خلال مزيج من الافتتاحات الجديدة والتجديدات وتوسيع الحضور عبر القنوات المتعددة.</span>,
          <span>بلغت إيرادات قطاع الأغذية والمشروبات 328 <span className="riyal-small">&</span> مليون في عام 2024م، بانخفاض قدره 13,5% على أساس سنوي، ويرجع ذلك إلى حد كبير إلى إغلاق 35 متجراً غير مربح كجزء من برنامج ترشيد العلامات التجارية والتأثير المستمر للبرنامج وهو تأثير قصير الأجل حتى يتم التخارج من العلامات التجارية المستهدفة. ومع ذلك، أظهرت صب واي زخماً استثنائياً، حيث ارتفعت الإيرادات بنسبة 75,6% على أساس سنوي في عام 2024م (بنهاية العام). كان هذا النمو مدفوعاً بعمليات الافتتاح القياسية للمتاجر الجديدة، بما في ذلك 12 متجراً في يوم واحد في أكتوبر و14 متجراً في ديسمبر. وشملت هذه الافتتاحات مزيجاً من المنافذ التقليدية والمطابخ السحابية والأماكن غير التقليدية مثل البنوك والمستشفيات، مما يشير إلى نموذج نمو أكثر مرونة وتنوعاً للأعمال.</span>,
          <span>وبلغت إيراداتنا من التجارة الإلكترونية 363 <span className="riyal-small">&</span> مليون في عام 2024م، مما يمثل 7,5% من إجمالي المبيعات. وبينما يعكس هذا انخفاضاً بنسبة 2,9% على أساس سنوي متأثراً مؤقتاً ببرنامج ترشيد العلامات التجارية، حققنا تقدماً تشغيلياً كبيراً، ونتوقع تحقيق أداء أفضل من أعمال التجارة الإلكترونية، بناءً على التحسينات التشغيلية التي تم تنفيذها في عام 2024م. وشكّل إطلاق أربع علامات تجارية من إنديتكس على منصة ترينديول علامة فارقة في استراتيجية التكامل مع المنصات والأسواق الإلكترونية، بينما عززت الاستثمارات في الحلول اللوجستية المحلية وطرح متاجر جديدة عبر الإنترنت في أوزبكستان من الوصول الإقليمي للشركة، وهو جزء من استراتيجيتنا للتوسع الرقمي سواء من خلال أسواق الطرف الثالث عبر الإنترنت أو الأسواق ذات الإمكانات الواعدة مثل أوزبكستان. ونمت الإيرادات الرقمية لزارا وإنديتكس بنسبة 6,6% على أساس سنوي، مما يبرز مساراً واضحاً للأعمال في عام 2025م.</span>,
        ],
      ],
      reshaping: ["Reshaping Our Footprint for Sustainable Growth", "إعادة تشكيل بصمتنا الجغرافية لتحقيق نمو مستدام"],
      reshapingText: [
        [
          <span>
        ...
        [
          <span>اتخذت سينومي ريتيل خلال عام 2024م إجراءات مدروسة واستراتيجية لإعادة مواءمة بصمتها المادية دعماً لبرنامجها المستمر لترشيد العلامات التجارية. تم إغلاق ما مجموعه 558 متجراً خلال العام، بما في ذلك 486 متجراً في المملكة العربية السعودية، كجزء من الخروج المنضبط للشركة من العلامات التجارية غير الأساسية والمواقع ذات الأداء الضعيف. تم موازنة عمليات الإغلاق هذه بـ 93 افتتاحاً جديداً للمتاجر – 41 في قطاع التجزئة و52 في قطاع الأغذية والمشروبات – مع التركيز على العلامات التجارية الرائدة في السوق ضمن المواقع الرئيسية. وتتم مراقبة الأداء عبر الشبكة المُحدّثة عن كثب لضمان التوافق مع أهداف الربحية طويلة الأجل للشركة بهدف بناء شبكة متاجر أكثر تركيزاً وكفاءة، مُصممة لدعم الربحية واستدامة الأداء الإيجابي على المدى الطويل.</span>,
          <span>وشهد الربع الرابع من العام تنفيذ النهج الاستراتيجي ذاته، من خلال 17 إغلاقاً و45 افتتاحاً جديداً، ما مثل إضافة صافية بلغت 28 متجراً. والأهم من ذلك، كانت جميع عمليات الإغلاق في الربع الرابع جزءاً من التناقص الطبيعي للأعمال وليست مرتبطة بعمليات تصفية الاستثمارات غير الأساسية، مما يؤكد التزام الشركة بالتقليص المدروس لمحفظتها في إطار التزامها بالتقييم المنتظم للأداء. وفي قطاع الأغذية والمشروبات، افتتحت سينومي ريتيل 35 منفذاً جديداً وأغلقت 10 منافذ، محافظة على استراتيجية التوسع المتمحورة حول نماذج التجزئة المناسبة والمواقع عالية الحركة.</span>,
          <span>ومن شأن هذا الترشيد للمحفظة أن يحقق مستويات كفاءة تشغيلية ملموسة. حيث يبلغ عدد المتاجر عبر عمليات التجزئة في السعودية حالياً 360 متجراً، بينما يبلغ إجمالي الشبكة الدولية 249 متجراً. وأنهى قطاع الأغذية والمشروبات، المدعوم بمستويات توسع قياسية، العام بصافي 271 منفذاً. هذه التعديلات – إلى جانب تحسين إدارة المخزون، وترشيد عمليات المتاجر، والتركيز الدقيق على العلامات التجارية الأفضل أداءً – ستعزز أسس أعمال سينومي ريتيل وتدعم طموحاتها للنمو. وبالتالي، تدخل الشركة عام 2025م بشبكة متاجر أكثر تركيزاً ومرونة بما يتوافق مع رؤيتها طويلة الأجل.</span>,
        ],
      ],
      developing: ["Developing Our Workforce. Empowering Our Talent", "تطوير قوتنا العاملة وتمكين مواهبنا الوطنية"],
      developingText: [
        [
          <span>
        ...
        [
          <span>تزامن تحول سينومي ريتيل خلال العام الماضي مع استثمار متجدد في تطوير قاعدة موظفينا. ومع تطور الأعمال، أعطينا الأولوية لمواءمة حجم القوى العاملة مع الأهداف الاستراتيجية الجديدة. وضمنت التعيينات الرئيسية عبر ثماني دول بقاء شبكة متاجرنا عاملة بكفاءة ومستجيبة لظروف الطلب، حيث تم توظيف 2,676 موظفاً جديداً وأكمل 85% من القوى العاملة برنامج تدريب واحد على الأقل. وساعد رفع مهارات كوادرنا البشرية في مجالات مهمة، خاصة حول مفاهيم العلامات التجارية الجديدة والأدوات الرقمية، في دفع الأداء التشغيلي، بينما حافظت مبادرات التواصل المركزة والتوزيع الداخلي المدروس للكفاءات على تعزيز مشاركة الموظفين خلال فترة التحول الكبير.</span>,
          <span>وانخفض معدل دوران موظفي المتاجر إلى 40% في عام 2024م من 70% في العام السابق، مما يعكس جهودنا المعززة للاحتفاظ بالموظفين. وساعدت فرص التطوير المهني، وتحسين عمليات الإلحاق، وبرامج تقدير الأداء المتميز عبر جميع الأسواق في تعزيز ثقافة الانتماء والمرونة. وعلى مستوى المملكة وحدها، تم توظيف 1,499 مواطناً ومواطنة، مما يؤكد التزامنا المستمر بالتوطين وتطوير المواهب السعودية. وفي الوقت نفسه، عززت المبادرات الأوسع عبر الأردن وأوزبكستان وأرمينيا وغيرها من تماسك الفريق وحافظت على جودة الخدمة أثناء إعادة الهيكلة.</span>,
          <span>ترتبط استراتيجيتنا للموارد البشرية ارتباطاً وثيقاً بأجندة الاستدامة الأوسع للشركة. ففي عام 2024م، واصلنا دمج ممارسات التوظيف الشاملة، وتعزيز التنوع، وضمان ظروف عمل عادلة عبر أسواقنا. ظلت رفاهية الموظفين، من الصحة النفسية إلى المرونة في مكان العمل، محور تركيز رئيسي، وعززت مبادراتنا الثقافية معنويات الموظفين. هذه الجهود ليست سوى مثالاً على جهود التحول الشاملة التي نبذلها لجعل سينومي ريتيل أكثر كفاءة ومرونة وأتم استعداداً للفصل التالي من مسيرة نموها.</span>,
        ],
      ],
      moving: ["Moving with Purpose for Long-term Growth", "تقدمٌ واثق نحو نمو طويل الأجل"],
      movingText: [
        [
          <span>
        ...
        [
          <span>
            استكمالاً للإنجازات التي تحققت في العام الماضي، تتطلع سينومي ريتيل للانتقال من مرحلة ترشيد محفظة العلامات التجارية إلى مرحلة جديدة من التوسع المركّز والتطور التشغيلي. وبعد التخارج الناجح من 24 علامة تجارية غير أساسية وتقليص إجمالي عدد المتاجر بنسبة 34,6%، يظل اهتمامنا الآن مركزاً على إعادة تشكيل محفظة المتاجر. وسنحقق ذلك عبر استثمارات مستهدفة في تجديد وتوسيع متاجر العلامات التجارية الرائدة في المواقع الحيوية، بالإضافة إلى تعزيز رحلة العملاء والارتقاء بتجاربهم داخل المتاجر من خلال تحديث التصاميم، وتوظيف أحدث تقنيات غرف القياس وحلول الدفع الذاتي. سيعطي برنامج التجديد الأولوية للمتاجر ذات الأهمية الاستراتيجية والإمكانات التشغيلية المؤثرة، بناءً على النتائج المشجعة التي شوهدت من عمليات التطوير الناجحة مثل متجر زارا الرئيسي في النخيل مول.
          </span>,
          <span>
            ‫تتمثل رؤيتنا لعام 2025م في البناء على النجاحات والكفاءات التي حققناها عبر مختلف أعمالنا. وبعد أن تمكنا من خفض صافي الدين بنسبة 31,6% في عام 2024م، أصبحنا في وضع قوي يتيح لنا إعادة توجيه الموارد نحو تحقيق نمو مستدام، مع الالتزام الصارم بالانضباط المالي. نعتزم مواصلة تحسين أدائنا التشغيلي من خلال تعزيز حضورنا في الأسواق المحلية والدولية، وتوسيع نطاق مبادراتنا في التجارة الإلكترونية، إلى جانب تطوير صيغ جديدة تدعم تحقيق أرباح مستدامة. ‫ومع دخولنا المرحلة الثانية من استراتيجيتنا، تواصل سينومي ريتيل تركيزها القوي على التنفيذ الدقيق، والابتكار الذي يركز على تلبية احتياجات العملاء، والعمل على تحقيق القيمة المضافة في جميع مجالات أعمالنا.‬‬‬‬‬‬
          </span>
        ],
      ],
      acknowledgment: ["Acknowledgments", "شكر وامتنان"],
      acknowledgmentText: [
        [
          <span>
        ...
        [
          <span>بالأصالة عن نفسي، أتوجه بالشكر والامتنان إلى رئيس مجلس الإدارة وجميع أعضاء المجلس الموقرين على رؤيتهم الثاقبة ودعمهم الراسخ خلال هذه المرحلة المفصلية من رحلة التحول الشاملة. لقد شكّلت توجيهاتهم الحكيمة الأساس المتين الذي مكّننا من اجتياز التحديات المعقدة بانضباط عالٍ وهدف واضح المعالم. كما أعرب عن تقديري العميق لفرق عملنا المتميزة عبر جميع الأسواق، الذين واصل تفانيهم الاستثنائي وقدرتهم المتقدمة على التكيف دفع عجلة التقدم والإنجاز. </span>,
          <span>وإنني ممتن بالقدر ذاته لشركائنا من أصحاب العلامات التجارية وشركاء الأعمال على ثقتهم الدائمة، ولعملائنا الكرام الذين يُلهمنا ولاؤهم الثابت لمواصلة تخطي حدود التوقعات ورفع سقف الطموحات. إن كل إنجاز حققناه هذا العام يعكس قوة هذه الشراكات الاستراتيجية والتزامنا المشترك الراسخ بتقديم قيمة استثنائية تفوق التوقعات. </span>,
          <span>وفيما نتطلع بثقة إلى المستقبل، فإننا نمضي قُدماً برؤية واضحة وثقة راسخة وعزيمة متجددة. لقد باتت شركة سينومي ريتيل اليوم أكثر تركيزاً في توجهاتها، وأعلى مرونة في استراتيجياتها، وأكثر استعداداً من أي وقت مضى لقيادة دفة الفصل القادم من مسيرة تطوير قطاع التجزئة الحديثة وازدهاره في المنطقة.</span>,
        ],
      ],
    },
    StrategicReview: {
